...
public:
	...
	jint javaDpGet(JNIEnv *env, jobject obj, jobject jHdl, /*String[]*/jobjectArray dps);
	...
	void doReceiveParent(SysMsg &msg);
	void doReceiveParent(DpMsg &msg);

	static PVSSboolean doExit;
	static PVSSboolean doPause;

	void sendArchivedElements(DynVar& values, TimeVar& time, bool isAlert);
