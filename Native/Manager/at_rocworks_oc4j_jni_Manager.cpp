...
//#include <DbArchiveTypes.hxx>

//------------------------------------------------------------------------------------------------
// JAVA JNI startup

JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Manager_apiStartup
...
JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Manager_apiShutdown
(JNIEnv *, jobject)
{
...
JNIEXPORT void JNICALL Java_at_rocworks_oc4j_jni_Manager_apiDispatch
...
JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Manager_apiDpGet
(JNIEnv *env, jobject obj, jobject jHdl, jobjectArray dps)
{
	return WCCOAJavaManager::thisManager->javaDpGet(env, obj, jHdl, dps);
}

JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Manager_apiDpSet
(JNIEnv *env, jobject obj, jobject jHdl, jobjectArray dps)
{
	return WCCOAJavaManager::thisManager->javaDpSet(env, obj, jHdl, dps);
}

JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Manager_apiDpSetTimed
...
JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Manager_apiDpConnect
(JNIEnv *env, jobject obj, jobject jHdl, jstring dp)
{
	return WCCOAJavaManager::thisManager->javaDpConnect(env, obj, jHdl, dp);
}

JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Manager_apiDpDisconnect
(JNIEnv *env, jobject obj, jobject jHdl, jstring dp)
{
...
JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Manager_apiDpConnectArray
(JNIEnv *env, jobject obj, jobject jHdl, jobjectArray dps)
{
	return WCCOAJavaManager::thisManager->javaDpConnect(env, obj, jHdl, dps);
}

JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Manager_apiDpDisconnectArray
(JNIEnv *env, jobject obj, jobject jHdl, jobjectArray dps)
{
...
JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Manager_apiAlertConnect
(JNIEnv *env, jobject obj, jobject jHdl, jobjectArray dps)
{
	return WCCOAJavaManager::thisManager->javaAlertConnect(env, obj, jHdl, dps);
}

JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Manager_apiAlertDisconnect
(JNIEnv *env, jobject obj, jobject jHdl, jobjectArray dps)
{
...
JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Manager_apiDpQuery
...
JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Manager_apiDpQueryConnectSingle
...
JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Manager_apiDpQueryConnectAll
(JNIEnv *env, jobject obj, jobject jHdl, jboolean jValues, jstring jQuery)
{
	return WCCOAJavaManager::thisManager->javaDpQueryConnect(env, obj, jHdl, jValues, jQuery, false);
}

JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Manager_apiDpQueryDisonnect
...
JNIEXPORT jstring JNICALL Java_at_rocworks_oc4j_jni_Manager_apiGetLogPath
...
JNIEXPORT jstring JNICALL Java_at_rocworks_oc4j_jni_Manager_apiGetDataPath
(JNIEnv *env, jobject obj)
{
...
JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Manager_apiSendArchivedDPs
...
JNIEXPORT jobjectArray JNICALL Java_at_rocworks_oc4j_jni_Manager_apiGetIdSet
...
JNIEXPORT jobjectArray JNICALL Java_at_rocworks_oc4j_jni_Manager_apiGetIdSetOfType
...
JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Manager_apiProcessHotlinkGroup
...
//------------------------------------------------------------------------------------------------
/*
* Class:     at_rocworks_oc4j_jni_Manager
* Method:    apiDpGetComment
* Signature: (Lat/rocworks/oc4j/base/JDpId;)Lat/rocworks/oc4j/var/LangTextVar;
*/
JNIEXPORT jobject JNICALL Java_at_rocworks_oc4j_jni_Manager_apiDpGetComment
...
* Signature: (J)V
*/
JNIEXPORT void JNICALL Java_at_rocworks_oc4j_jni_Manager_apiDoReceiveSysMsg
(JNIEnv *env, jobject obj, jlong ptrMsg)
{
	SysMsg *msg = (SysMsg*)ptrMsg;
	WCCOAJavaManager::thisManager->doReceiveParent(*msg);
}
...
* Signature: (J)V
*/
JNIEXPORT void JNICALL Java_at_rocworks_oc4j_jni_Manager_apiDoReceiveDpMsg
(JNIEnv *env, jobject obj, jlong ptrMsg)
{
	DpMsg *msg = (DpMsg*)ptrMsg;
	WCCOAJavaManager::thisManager->doReceiveParent(*msg);
}
...
* Signature: (I)V
*/
JNIEXPORT void JNICALL Java_at_rocworks_oc4j_jni_Manager_apiSetManagerState
