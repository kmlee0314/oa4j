#include <at_rocworks_oc4j_jni_Msg.h>
#include <WCCOAJavaManager.hxx>

JNIEXPORT jint JNICALL Java_at_rocworks_oc4j_jni_Msg_isA
...
JNIEXPORT jlong JNICALL Java_at_rocworks_oc4j_jni_Msg_getMsgId
...
JNIEXPORT void JNICALL Java_at_rocworks_oc4j_jni_Msg_forwardMsg
...
JNIEXPORT void JNICALL Java_at_rocworks_oc4j_jni_Msg_forwardMsgToData
(JNIEnv *env, jobject obj)
{
	jclass cls;
...
JNIEXPORT jstring JNICALL Java_at_rocworks_oc4j_jni_Msg_toString
(JNIEnv *env, jobject obj)
{
	jclass cls = env->GetObjectClass(obj);
	Msg *msg = (Msg*)env->GetLongField(obj, env->GetFieldID(cls, "cptr", "J"));
...
JNIEXPORT jstring JNICALL Java_at_rocworks_oc4j_jni_Msg_toDebug
...
JNIEXPORT void JNICALL Java_at_rocworks_oc4j_jni_Msg_free
(JNIEnv *, jobject, jlong cptr)
{
